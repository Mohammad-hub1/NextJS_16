...
//       data-slot="card"
//       className={cn(
//         "bg-card text-card-foreground font-bold flex flex-col gap-6 rounded-xl border py-6 shadow-sm",
//         className
//       )}
//       {...props}
//     />
...
// function AppCardTitle({ className, ...props }: React.ComponentProps<"div">) {
//   return (
//     <div
...
// function AppCardAction({ className, ...props }: React.ComponentProps<"div">) {
//   return (
//     <div
